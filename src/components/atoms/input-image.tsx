...
const InputImage: React.FC<{
  ...
  return (
    <label className='grow cursor-pointer max-w-[350px]'>
      ...
      <div className='relative w-full overflow-hidden max-w-[350px] h-full max-h-[260px] border-2 border-primary/50 rounded-[10px]'>
        {image && (
          <Image
            alt='preview image'
